#ifndef LAT1DFLAT1STOxH
#define LAT1DFLAT1STOxH
...
///
class Lat1DFlat1stO : virtual public Lat1DFlat, virtual public Lat1stO {
  public:
///
	Lat1DFlat1stO() {};
///
	Lat1DFlat1stO(Input*, Text);
///
	virtual ~Lat1DFlat1stO();
