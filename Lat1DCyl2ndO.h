#ifndef LAT1DCYL2NDOxH
#define LAT1DCYL2NDOxH
...
///
class Lat1DCyl2ndO : virtual public Lat1DCylinder, virtual public Lat1DFlat, virtual public Lat2ndO {
  public:
///
	Lat1DCyl2ndO() {};
///
	Lat1DCyl2ndO(Input*, Text);
///
	virtual ~Lat1DCyl2ndO();
